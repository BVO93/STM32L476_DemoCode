...
int main() {
	...
	// set first bit as one
	//SCB-> SCR |= (1 << 1);

	// Or use Mx software api
...
// Callback after Interupt
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{

	HAL_UART_Transmit(&huart2, (uint8_t*) someData, strlen((char*)someData), HAL_MAX_DELAY);
