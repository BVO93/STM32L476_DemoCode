...
// Not fully working. Maybe something due to type of up
...
int main() {
	...
	while (1){
		...
		// Supress the systick or it will wake you every ms
		HAL_SuspendTick();


		// going to sleep
		__WFE();
		// if pressed the up wakes up in resumes
...
// Dont neet beacuse no interrupt .It is set as event
